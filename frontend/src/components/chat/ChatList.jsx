            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                <div className="relative flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden shadow-md bg-gray-200 flex-shrink-0">
                    {u.profilePicture ? (
                      <img
                      ...
                      <div
                        className={`w-full h-full flex items-center justify-center text-white font-semibold text-sm sm:text-lg ${
                          selectedUserId === u._id
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-0.5 gap-2">
                    ...
                    <div className="flex flex-col items-end gap-1 flex-shrink-0">
                      ...
                      {u.unreadCount > 0 && (
                        <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-green-500 text-white text-[11px] font-semibold flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-1 mb-0.5 flex-wrap">
                    <span
                      className={`inline-flex items-center gap-0.5 px-1.5 sm:px-2 py-0.5 rounded-full text-xs font-medium ${roleStyle.bg} ${roleStyle.text} flex-shrink-0`}
                    >
                      {roleStyle.icon}
